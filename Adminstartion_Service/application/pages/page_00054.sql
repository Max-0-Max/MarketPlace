...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80242782141938850)
,p_plug_name=>'Disbursed Loan Report'
,p_icon_css_classes=>'fa-credit-card-front'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(161934708928527658)
...
'AND B.PERSON_ID = NVL(:P54_EMPLOYEE,B.PERSON_ID)',
'AND A.LOAN_STATUS = NVL(:P54_STATUS,A.LOAN_STATUS)',
'AND (',
'    (:P54_START_DATE IS NULL OR TRUNC(A.START_DATE) >= TO_DATE(:P54_START_DATE)) AND',
'    (:P54_END_DATE   IS NULL OR TRUNC(A.END_DATE)   <= TO_DATE(:P54_END_DATE))',
')',
'',
''))
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(161934817682527658)
,p_name=>'Loan Disbursement Report'
...
,p_owner=>'DADEGBITE'
,p_internal_uid=>161934817682527658
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161935893446527661)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161936322144527661)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161941152871527666)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161976431958546300)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161979579165546332)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(84280430728879314)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(163634054354186238)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84233321768479489)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(161934708928527658)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160862990869763823)
,p_name=>'P54_EMPLOYEE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(161934708928527658)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160863057401763824)
,p_name=>'P54_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(161934708928527658)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160863146921763825)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160863255403763826)
,p_name=>'P54_END_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(161934708928527658)
,p_prompt=>'End Date'
