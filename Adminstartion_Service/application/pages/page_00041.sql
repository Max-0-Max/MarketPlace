...
,p_alias=>'CREATE-NEW-COMPANY1'
,p_page_mode=>'MODAL'
,p_step_title=>'Create New Company'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(148534905460149146)
,p_plug_name=>'New'
...
'                    <div class="page-title">''||:P41_SET_ADD_UPDATE||''</div>',
'            </div>    ',
'        '');'))
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(148535006652149147)
...
'           --  AND COMPANY_ID = :P41_COMPANY_ID'))
,p_is_editable=>false
,p_plug_source_type=>'NATIVE_FORM'
,p_ai_enabled=>false
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(49165978108476765)
,p_button_sequence=>140
,p_button_plug_id=>wwv_flow_imp.id(148535006652149147)
...
,p_button_condition=>'P41_COMPANY_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_grid_new_row=>'Y'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(49166350056476769)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(49173905576476877)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93174689734489613)
,p_name=>'P41_COMPANY_ID'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_item_source_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_source=>'COMPANY_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93174753286489614)
,p_name=>'P41_COMPANY_NAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93174936257489616)
,p_name=>'P41_COMPANY_DESC'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_item_source_plug_id=>wwv_flow_imp.id(148535006652149147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93175105443489617)
,p_name=>'P41_STATUS'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93769712340533181)
,p_name=>'P41_UPLOAD_IMG'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(93769904651533183)
,p_name=>'P41_DISPLAY_IMAGE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_item_default=>'https://testapp.softsuite.com/softsuite/api/mrkt/getimages/&P41_COMPANY_ID.'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97584326392985693)
,p_name=>'P41_COMPANY_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_item_source_plug_id=>wwv_flow_imp.id(148535006652149147)
...
,p_cHeight=>1
,p_read_only_when=>'P41_COMPANY_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97585538212985705)
,p_name=>'P41_SET_ADD_UPDATE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select ',
'    case ',
'        when :P41_COMPANY_ID is null Then',
'            ''Add New Company''',
'        else',
'            ''Edit Company''',
'    end',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97585764436985707)
,p_name=>'P41_ID'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'WHERE COMPANY_ID = :P41_COMPANY_ID',
'AND COMPANY_CODE = :AP_COMPANY_CODE'))
,p_source_type=>'QUERY'
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(97586209114985711)
,p_name=>'P41_BENEFITS'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(148535006652149147)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(49172942242476861)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(49173408563476874)
,p_event_id=>wwv_flow_imp.id(49172942242476861)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(49172556152476860)
...
'DECLARE',
'BEGIN',
'    xxmrkt.xxmrkt_marketplace_pkg.create_company(   p_company_name => :P41_COMPANY_NAME,',
'                                                    p_company_type => :P41_COMPANY_TYPE,',
'                                                    p_company_desc => :P41_COMPANY_DESC,',
'                                                    p_status       => :P41_STATUS,',
'                                                    p_upload_img   => :P41_UPLOAD_IMG,',
'                                                    p_benefits     => :P41_BENEFITS',
'                                                );',
'EXCEPTION ',
'    WHEN OTHERS THEN',
...
,p_process_when_button_id=>wwv_flow_imp.id(49165978108476765)
,p_internal_uid=>49172556152476860
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(49172140579476859)
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'   XXMRKT.XXMRKT_MARKETPLACE_PKG.update_company(p_company_name => :P41_COMPANY_NAME,',
'                                                p_id           => :P38_ID,',
'                                                p_company_id   => :P41_COMPANY_ID,',
'                                                p_company_type => :P41_COMPANY_TYPE,',
'                                                p_company_desc => :P41_COMPANY_DESC,',
'                                                p_status       => :P41_STATUS,',
'                                                p_upload_img   => :P41_DISPLAY_IMAGE,',
'                                                p_benefits     => :P41_BENEFITS',
'                        );',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(49166350056476769)
,p_internal_uid=>49172140579476859
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(49171320809476812)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_imp.id(148535006652149147)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form Create New Product'
,p_internal_uid=>49171320809476812
);
