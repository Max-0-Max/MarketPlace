...
,p_alias=>'APROVED-LOAN-REPORT'
,p_step_title=>'Aproved Loan Report'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(80242567369938848)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(161892745592497475)
,p_plug_name=>'Approved Loan Report'
...
'AND B.PERSON_ID = NVL(:P50_EMPLOYEE,B.PERSON_ID)',
'AND A.LOAN_STATUS = NVL(:P50_STATUS,A.LOAN_STATUS)',
'AND (',
'    (:P50_START_DATE IS NULL OR TRUNC(A.START_DATE) >= TO_DATE(:P50_START_DATE)) AND',
'    (:P50_END_DATE   IS NULL OR TRUNC(A.END_DATE)   <= TO_DATE(:P50_END_DATE))',
')',
'',
''))
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(161892829990497475)
...
,p_owner=>'DADEGBITE'
,p_internal_uid=>161892829990497475
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161958189661533744)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(161959149531533754)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(164448516697405715)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(164448642888405716)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(164448752837405717)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(84280300938879313)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(161969893698659321)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(84212751155466914)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(161892745592497475)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160841293527751239)
,p_name=>'P50_EMPLOYEE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(161892745592497475)
,p_prompt=>'Employee'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160841392730751240)
,p_name=>'P50_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(161892745592497475)
,p_prompt=>'Status'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160841465474751241)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(160841546833751242)
,p_name=>'P50_END_DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(161892745592497475)
,p_prompt=>'End Date'
