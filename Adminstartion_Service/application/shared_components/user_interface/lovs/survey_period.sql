...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(69513624636845402)
,p_lov_name=>'SURVEY_PERIOD'
,p_lov_query=>'.'||wwv_flow_imp.id(69513624636845402)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69513838947845404)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Post Course'
,p_lov_return_value=>'POST'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69514290701845404)
