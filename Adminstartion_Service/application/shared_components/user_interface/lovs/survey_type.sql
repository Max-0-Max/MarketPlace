...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(69359696790994464)
,p_lov_name=>'SURVEY_TYPE'
,p_lov_query=>'.'||wwv_flow_imp.id(69359696790994464)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69360001138994464)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Self Selected'
,p_lov_return_value=>'SELF-SELECT'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(69360354298994464)
