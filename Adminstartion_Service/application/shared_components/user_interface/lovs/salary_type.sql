prompt --application/shared_components/user_interface/lovs/salary_type
begin
--   Manifest
--     SALARY TYPE
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(51532235838644343)
,p_lov_name=>'SALARY TYPE'
