prompt --application/shared_components/user_interface/lovs/job_title
begin
--   Manifest
--     JOB TITLE
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(51528355285644341)
,p_lov_name=>'JOB TITLE'
