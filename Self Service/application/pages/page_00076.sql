...
wwv_flow_imp_page.create_page(
 p_id=>76
,p_name=>'&P71_HEADER 2'
,p_alias=>'P71-HEADER-2'
,p_page_mode=>'MODAL'
,p_step_title=>'&P71_HEADER 2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(130742165850585310)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(150366338182800950)
,p_plug_name=>'New1'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(2487513223224052)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(283912663531471661)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(2487513223224052)
...
'    WHERE COMPANY_ID = :P76_COMPANY_ID',
'    AND COMPANY_cODE = :AP_COMPANY_CODE',
'    AND PRODUCT_ID = :P76_PRODUCT_ID;',
'RETURN',
'''<div class="loan-card">',
'  <div class="loan-header">',
'    <img src="https://testapp.softsuite.com/softsuite/api/mrkt/getimages/''||:P76_COMPANY_ID||''" alt="Loan Icon" class="loan-icon">',
'    <h3>''||:P76_HEADER||''</h3>',
'  </div>',
'',
'  <div class="loan-details">',
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(76970319225740962)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_button_name=>'Apply'
...
,p_button_condition=>'P76_LOAN_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_grid_new_row=>'Y'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(76970771930740967)
...
,p_warn_on_unsaved_changes=>null
,p_button_condition=>':P76_LOAN_ID IS NOT NULL AND :P76_LOAN_STATUS = ''Initiated'''
,p_button_condition2=>'PLSQL'
,p_button_condition_type=>'EXPRESSION'
,p_grid_new_row=>'Y'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130743754076585373)
,p_name=>'P76_REPAYMENT_PERIOD'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_prompt=>'<p class="input-loan">&P76_CONTROL.</p>'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT LEVEL || '' Months'' AS num1, LEVEL AS num2',
'FROM dual',
'CONNECT BY LEVEL <= :P76_MAXIMUM_REPAYMENT_PERIOD',
'MINUS',
'SELECT LEVEL || '' Months'' AS num1, LEVEL AS num2',
'FROM dual',
'CONNECT BY LEVEL < :P76_MINIMUM_REPAYMENT_PERIOD;'))
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_read_only_when=>'P76_LOAN_ID'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130743791271585374)
,p_name=>'P76_AMOUNT_TO_BORROW'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130743878342585375)
,p_name=>'P76_RECEIVING'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130744255542585378)
,p_name=>'P76_MINIMUM_REPAYMENT_PERIOD'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130744315700585379)
,p_name=>'P76_MAXIMUM_REPAYMENT_PERIOD'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130747621060585393)
,p_name=>'P76_COMPANY_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(283912663531471661)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
,p_ai_enabled=>false
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130747733420585394)
,p_name=>'P76_PRODUCT_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(283912663531471661)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(130748079605585417)
,p_name=>'P76_RECEIVING_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(133726576010670469)
,p_name=>'P76_MINIMUM_LIMIT'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(133726682440670470)
,p_name=>'P76_MAXIMUM_LIMIT'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(133727480339670478)
,p_name=>'P76_ELIGIBILITY_ERR'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141169390340579710)
,p_name=>'P76_LOAN_ID'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141169941146579715)
,p_name=>'P76_LOAN_STATUS'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(141174325801579740)
,p_name=>'P76_HEADER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(283912663531471661)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(143559073784990376)
,p_name=>'P76_ACTION'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(144047433339504537)
,p_name=>'P76_COMPANY_TYPE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(283912663531471661)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(150373706090801045)
,p_name=>'P76_USER_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(150366338182800950)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'Y')).to_clob
,p_ai_enabled=>false
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(150373829761801046)
,p_name=>'P76_COMPANY_ID_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(150366338182800950)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(150799618219762696)
,p_name=>'P76_CONTROL'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_imp.id(130742165850585310)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76978949478741038)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76979471140741042)
,p_event_id=>wwv_flow_imp.id(76978949478741038)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76979836957741043)
,p_name=>'Set Receiving Value'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P76_AMOUNT_TO_BORROW'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'keyup'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76980399948741044)
,p_event_id=>wwv_flow_imp.id(76979836957741043)
,p_event_result=>'TRUE'
...
'var input = $v(''P76_AMOUNT_TO_BORROW''); // get current input value',
'',
'if (!input) return;',
'',
...
'$s(''P76_AMOUNT_TO_BORROW'', formatted);',
''))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76981863877741047)
,p_event_id=>wwv_flow_imp.id(76979836957741043)
,p_event_result=>'TRUE'
...
,p_affected_elements=>'P76_RECEIVING_1'
,p_attribute_01=>'FUNCTION_BODY'
,p_attribute_06=>wwv_flow_string.join(wwv_flow_t_varchar2(
'RETURN XXMRKT.XXMRKT_MARKETPLACE_PKG.calculate_receiving_amount(    ',
'                                                                p_company_id => :P76_COMPANY_ID,',
'                                                                p_product_id => :P76_PRODUCT_ID,',
'                                                                p_amount_to_borrow => :P76_AMOUNT_TO_BORROW',
'                                                            );'))
,p_attribute_07=>'P76_AMOUNT_TO_BORROW,P76_PRODUCT_ID,P76_COMPANY_ID'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76980892069741044)
,p_event_id=>wwv_flow_imp.id(76979836957741043)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P76_RECEIVING,P76_RECEIVING_1'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'}',
'',
'var input = $v(''P76_RECEIVING_1''); // get current input value',
'if (!input) return;',
'',
'// Remove all non-digit characters except decimal point if needed',
...
'',
'// Set formatted value back to the item',
'$s(''P76_RECEIVING'', formatted);',
''))
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76981345125741045)
,p_event_id=>wwv_flow_imp.id(76979836957741043)
,p_event_result=>'TRUE'
...
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P76_RECEIVING'
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76982263978741047)
,p_name=>'submit loan'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(76970319225740962)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76982751035741049)
,p_event_id=>wwv_flow_imp.id(76982263978741047)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P76_ELIGIBILITY_ERR'
,p_attribute_01=>'FUNCTION_BODY'
,p_attribute_06=>wwv_flow_string.join(wwv_flow_t_varchar2(
'RETURN XXMRKT.XXMRKT_MARKETPLACE_PKG.check_eligibility(p_amount     => :P76_AMOUNT_TO_BORROW, ',
'                                                       p_duration   => :P76_REPAYMENT_PERIOD,',
'                                                       p_company_id => :P76_COMPANY_ID,',
'                                                       p_product_id => :P76_PRODUCT_ID',
'                                                       );'))
,p_attribute_07=>'P76_AMOUNT_TO_BORROW,P76_REPAYMENT_PERIOD'
,p_attribute_08=>'Y'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76983228630741052)
,p_event_id=>wwv_flow_imp.id(76982263978741047)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76983796577741053)
,p_event_id=>wwv_flow_imp.id(76982263978741047)
,p_event_result=>'TRUE'
...
'    v_cnt NUMBER;',
'BEGIN',
'    XXMRKT.XXMRKT_MARKETPLACE_PKG.create_loan(    p_amount_to_borrow  => :P76_AMOUNT_TO_BORROW,',
'                                                  p_repayment_period  => :P76_REPAYMENT_PERIOD,',
'                                                  p_receiving_amount  => :P76_RECEIVING,',
'                                                  p_product_id        => :P76_PRODUCT_ID,',
'                                                  p_company_id        => :P76_COMPANY_ID',
'    );',
'END;'))
,p_attribute_02=>'P76_COMPANY_ID,P76_PRODUCT_ID,P76_AMOUNT_TO_BORROW,P76_REPAYMENT_PERIOD'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
,p_client_condition_type=>'NULL'
,p_client_condition_element=>'P76_ELIGIBILITY_ERR'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76984238402741053)
,p_event_id=>wwv_flow_imp.id(76982263978741047)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CLOSE'
,p_attribute_01=>'P76_COMPANY_ID,P76_PRODUCT_ID'
,p_client_condition_type=>'NULL'
,p_client_condition_element=>'P76_ELIGIBILITY_ERR'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76984689408741053)
,p_name=>'cancel loan'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(76970771930740967)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76985194754741054)
,p_event_id=>wwv_flow_imp.id(76984689408741053)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76978102005741037)
...
'',
'    apex_util.set_session_state(p_name => ''P76_AMOUNT_TO_BORROW'', p_value => V_LOAN_AMOUNT);',
'    apex_util.set_session_state(p_name => ''P76_REPAYMENT_PERIOD'', p_value => V_DURATION);',
'    apex_util.set_session_state(p_name => ''P76_RECEIVING'', p_value => V_RECEIVING_AMOUNT);',
'    apex_util.set_session_state(p_name => ''P76_LOAN_STATUS'', p_value => V_LOAN_STATUS);',
'    apex_util.set_session_state(p_name => ''P76_HEADER'', p_value => V_HEADER);',
'EXCEPTION',
'    WHEN OTHERS THEN',
'        NULL;',
'END;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76978102005741037
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76977840632741036)
...
'    INTO :P76_MINIMUM_LIMIT, :P76_MAXIMUM_LIMIT',
'    FROM XXMRKT.XXMRKT_PRODUCT_LIST',
'    WHERE COMPANY_cODE = :AP_COMPANY_cODE',
'    AND COMPANY_ID = :P76_COMPANY_ID',
'    AND PRODUCT_ID = :P76_PRODUCT_ID;',
'',
'EXCEPTION',
...
'END;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76977840632741036
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76978597290741037)
,p_process_sequence=>10
...
'END;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76978597290741037
);
