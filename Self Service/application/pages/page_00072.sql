...
wwv_flow_imp_page.create_page(
 p_id=>72
,p_name=>'Marketplace Product Details TEST'
,p_alias=>'MARKETPLACE-PRODUCT-DETAILS-TEST'
,p_step_title=>'Marketplace Product Details TEST'
...
'        productData = [...data];        // Assign server data to global variable',
'        currentPage = 1;                // Reset to page 1',
'        renderTablePage(currentPage);  // Call your existing render function',
'      },',
...
'}',
'',
'function redirectToModalPage71ApplyForLoan(pageID, compID, productID) {',
'        var url = `f?p=#APP_ID#:${pageID}:#SESSION#::NO:RP,${pageID}:P71_COMPANY_ID,P71_PRODUCT_ID,P71_HEADER,P71_CONTROL:${compID},${productID},Apply For Loan,Select Repayment Period`; //''f?p='' || l_app || '':''||apex_application.g_x01||'':''||l_session'
||'||''::NO::''||l_item_name||'':''||apex_application.g_x02,',
'        //var url = "f?p=#APP_ID#:"+''201''+":#SESSION#::NO:RP,201:";',
'        url = url.replace("#APP_ID#",&APP_ID.);',
'',
'        url = url.replace("#SESSION#", &SESSION.);',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170224819334446607)
,p_plug_name=>'New'
...
'                    <div class="img-div">',
'                        <img class ="prod-img" src="https://testapp.softsuite.com/softsuite/api/mrkt/getimages/''||:P72_COMPANY_ID||''" alt="group">',
'                    </div>',
'                    <div class="text-set">',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170225734112446616)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170226637684446625)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(136149001347400738)
,p_plug_name=>'Loan History'
,p_parent_plug_id=>wwv_flow_imp.id(170226637684446625)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170226713124446626)
...
'              benefits',
'             FROM XXMRKT.XXMRKT_COMPANY_LIST',
'             WHERE COMPANY_ID = :P72_COMPANY_ID',
'              and company_code = :AP_cOMPANY_cODE)',
'    loop',
'    ',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170226834619446627)
,p_plug_name=>'Product'
,p_parent_plug_id=>wwv_flow_imp.id(170226637684446625)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(2509084578224068)
...
'    BEGIN',
'        SELECT ',
'            decode(insfees_type, ''Percentage'', ''%'', ''Amount'', ''N''),',
'            decode(charges_type, ''Percentage'', ''%'', ''Amount'', ''N'')',
'        INTO v_insfees_type,',
'            v_charges_type',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(170226949228446629)
...
'            <button class="review-button" onclick="return redirectToModalPage69WriteAReview(69,''||:P72_COMPANY_ID||'')">Share a Review</button>',
'          </div>'');',
...
'                  <button onclick="return redirectToModalPage69UpdateReview(69,''||:P72_COMPANY_ID||'', ''||i.review_id||'')" class="action-btn edit">Edit Review</button>',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(170232551116446740)
,p_name=>'P72_COMPANY_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(170225734112446616)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76585543558243567)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76586060588243571)
,p_event_id=>wwv_flow_imp.id(76585543558243567)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76584336390243561)
...
,p_internal_uid=>76584336390243561
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76584772998243562)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76584772998243562
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76585166056243565)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76585166056243565
);
