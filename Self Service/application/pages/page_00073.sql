...
,p_alias=>'MARKETPLACE-PRODUCT-DETAILS-TEST1'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246811515173693257)
,p_plug_name=>'New'
...
'                    <div class="img-div">',
'                        <img class ="prod-img" src="https://testapp.softsuite.com/softsuite/api/mrkt/getimages/''||:P73_COMPANY_ID||''" alt="group">',
'                    </div>',
'                    <div class="text-set">',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246812429951693266)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246813333523693275)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(212735697186647388)
,p_plug_name=>'Loan History'
,p_parent_plug_id=>wwv_flow_imp.id(246813333523693275)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246813408963693276)
...
'              benefits',
'             FROM XXMRKT.XXMRKT_COMPANY_LIST',
'             WHERE COMPANY_ID = :P73_COMPANY_ID',
'              and company_code = :AP_cOMPANY_cODE)',
'    loop',
'    ',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246813530458693277)
,p_plug_name=>'Product'
,p_parent_plug_id=>wwv_flow_imp.id(246813333523693275)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_imp.id(2509084578224068)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(246813645067693279)
...
'            <button class="review-button" onclick="return redirectToModalPage69WriteAReview(69,''||:P73_COMPANY_ID||'')">Share a Review</button>',
'          </div>'');',
...
'                  <button onclick="return redirectToModalPage69UpdateReview(69,''||:P73_COMPANY_ID||'', ''||i.review_id||'')" class="action-btn edit">Edit Review</button>',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(246821777097693400)
,p_name=>'P73_COMPANY_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(246812429951693266)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(76591338073246664)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(76591891423246665)
,p_event_id=>wwv_flow_imp.id(76591338073246664)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76590109731246662)
...
,p_internal_uid=>76590109731246662
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76590545407246663)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76590545407246663
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(76590978417246664)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>76590978417246664
);
