...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(6095847578631223)
...
'     and (to_char(b.apex_page_no) = NVL(SUBSTR(:APP_PAGE_ALIAS,3),:APP_PAGE_ID) or NVL(SUBSTR(:APP_PAGE_ALIAS,3),:APP_PAGE_ID) = ''1'' or :APP_PAGE_ID in(''1'',''9999'',''9998'',''9997'',''9994'',''10011'',''10010'',''6'',''52'',''9993''))',
'      ;',
'      --',
...
,p_security_scheme=>'!'||wwv_flow_imp.id(11634307188315645)
,p_version_scn=>1
);
