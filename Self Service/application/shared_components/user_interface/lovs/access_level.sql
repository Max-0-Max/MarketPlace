...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1510517835380025)
,p_lov_name=>'ACCESS LEVEL'
,p_lov_query=>'.'||wwv_flow_imp.id(1510517835380025)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1510842325380026)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Global Access'
,p_lov_return_value=>'1'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1511174145380027)
