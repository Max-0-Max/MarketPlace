...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(1677433751843016)
,p_lov_name=>'ACTIVE_INACTIVE'
,p_lov_query=>'.'||wwv_flow_imp.id(1677433751843016)||'.'
,p_location=>'STATIC'
,p_version_scn=>1
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1677799440843019)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Active'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(1678228377843020)
