...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(377241685844738433)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377242001908738435)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377242346462738435)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377242837829738436)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377243205326738436)
,p_plugin_attribute_id=>wwv_flow_imp.id(377242837829738436)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377243680823738437)
,p_plugin_attribute_id=>wwv_flow_imp.id(377242837829738436)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(379729378129451329)
,p_plugin_attribute_id=>wwv_flow_imp.id(377242837829738436)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377244245572738437)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
,p_show_in_wizard=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377242001908738435)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377244621031738437)
,p_plugin_attribute_id=>wwv_flow_imp.id(377244245572738437)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377245106907738438)
,p_plugin_attribute_id=>wwv_flow_imp.id(377244245572738437)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377245572253738438)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377245989119738438)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377246422461738439)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377245989119738438)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377246810705738439)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(333005152696194581)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
,p_show_in_wizard=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377244245572738437)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(366938186888503846)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(366938688133506291)
,p_plugin_attribute_id=>wwv_flow_imp.id(366938186888503846)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(366939128217508087)
,p_plugin_attribute_id=>wwv_flow_imp.id(366938186888503846)
,p_display_sequence=>20
,p_display_value=>'Derived from Application Item'
,p_return_value=>'APEX_ITEM'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377247243613738440)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377247580876738440)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377248459068738440)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377248972963738441)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377249539582738441)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377250028249738441)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377250458086738442)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377250983677738442)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377247956445738440)
,p_plugin_attribute_id=>wwv_flow_imp.id(377247580876738440)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377251512291738442)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377251857067738442)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377256746285738445)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_display_sequence=>10
,p_display_value=>'Word (docx)'
,p_return_value=>'docx'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377253798283738444)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377254228542738444)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377254737276738444)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377255697347738445)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377253323825738443)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377252777073738443)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377255152853738444)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356323191793433186)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377252345725738443)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(367503732505731953)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(367504119015732816)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(367504460284734004)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(367504865537734840)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(367505326456735590)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377256212996738445)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(177034690323322221)
,p_plugin_attribute_id=>wwv_flow_imp.id(377251857067738442)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377257192567738445)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377257634754738446)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>10
,p_display_value=>'SQL'
,p_return_value=>'SQL'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377258087000738446)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377258620201738446)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377259102600738446)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377259610236738447)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(371669613599796478)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(371670010218797294)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(373316114417803887)
,p_plugin_attribute_id=>wwv_flow_imp.id(377257192567738445)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377260086560738447)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(371670694797802261)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377261005425738448)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377261485107738448)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377261966011738448)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>10
,p_display_value=>'SQL'
,p_return_value=>'SQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377260497273738447)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>15
,p_display_value=>'PL/SQL Function (returning SQL)'
,p_return_value=>'PLSQL_SQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377262528392738448)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>20
,p_display_value=>'PL/SQL Function (returning JSON)'
,p_return_value=>'PLSQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(381799288236162479)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377262992064738449)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(373306197256519295)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377263491905738449)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(366945611462609866)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(177032309880371542)
,p_plugin_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377264016866738449)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377260086560738447)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377264371912738449)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377251857067738442)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377264789063738450)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377265162555738450)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377265598336738450)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377265991205738451)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377266436310738451)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377266785511738451)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377268696358738452)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377267724197738452)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377268200393738452)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(377267199706738451)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(373305725857515426)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(379499257956954349)
,p_plugin_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(377269157412738453)
,p_plugin_id=>wwv_flow_imp.id(377241685844738433)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(377266785511738451)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
