...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(19631603674184545)
...
,p_reference_id=>2199366326695409532
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19631924045184553)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19632370109184555)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19632702094184556)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19633180364184557)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19633555992184557)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19633952014184558)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19634451915184559)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19634948355184559)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19635409959184560)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19635949636184560)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19636465442184561)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19636902198184562)
,p_plugin_attribute_id=>wwv_flow_imp.id(19633555992184557)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19637375015184562)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
,p_default_value=>'L'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(19640205743184565)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19637758712184562)
,p_plugin_attribute_id=>wwv_flow_imp.id(19637375015184562)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19638227447184563)
,p_plugin_attribute_id=>wwv_flow_imp.id(19637375015184562)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19638706519184564)
,p_plugin_attribute_id=>wwv_flow_imp.id(19637375015184562)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19639234974184564)
,p_plugin_attribute_id=>wwv_flow_imp.id(19637375015184562)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19639741090184565)
,p_plugin_attribute_id=>wwv_flow_imp.id(19637375015184562)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19640205743184565)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19640605009184566)
,p_plugin_attribute_id=>wwv_flow_imp.id(19640205743184565)
,p_display_sequence=>10
,p_display_value=>'Rectangular'
,p_return_value=>'BOX'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19641106817184566)
,p_plugin_attribute_id=>wwv_flow_imp.id(19640205743184565)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(19641687913184567)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19642046050184567)
,p_plugin_attribute_id=>wwv_flow_imp.id(19641687913184567)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(19642574779184568)
,p_plugin_attribute_id=>wwv_flow_imp.id(19641687913184567)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(19643927854184578)
,p_plugin_id=>wwv_flow_imp.id(19631603674184545)
,p_name=>'SOURCE_SQL'
